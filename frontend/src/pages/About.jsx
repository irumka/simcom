...
const roadmap = [
    {
        ...
        points: [
            'Формальная верификация ядра и математическое доказательство безопасности памяти.',
            'Microcode ROM: разделение макрокоманд на элементарные такты внутренних шин (RTL).'
        ],
    },
    {
        ver: 'v4.0',
        title: 'Аппаратная SoC-платформа',
        points: [
            'Интеграция системного таймера (IRQ0) для реализации вытесняющей многозадачности.',
            'Асинхронный DMA-контроллер для фонового копирования данных в обход АЛУ.'
        ],
    },
    {
        ver: 'v5.0',
        title: 'Наглядные спекуляции',
        points: [
            'Блок предсказания переходов (BTB) на 2-битных насыщающихся счетчиках.',
            'Интерактивный дашборд статистики попаданий/ошибок ветвления для обучения.'
        ],
    },
];
