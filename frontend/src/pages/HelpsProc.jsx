        ...
        <>
            ...
            <table className="table-cyber">
                ...
                <tbody>
                    ...
                    <tr>
                        <td className="td-node">
                            <span className="node-name clr-cyan">MMU</span>
                            <small className="node-sub">Блок трансляции адресов</small>
                        </td>
                        <td className="td-type">Memory Management Unit</td>
                        <td className="td-desc">
                            Переводит смещение, с которым работает программа, в физический адрес ячейки: physical = база сегмента + смещение. Заодно проверяет, что смещение не вылезло за размер сегмента, и глушит любую попытку дотянуться из DS или SS до CS.
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td className="td-desc">
                            Вызывает нужный метод ядра. АЛУ берёт операнды из регистров, вычисляет и записывает результат. Если инструкция обращается к памяти, адрес сначала проходит через MMU. Запись в сегмент кода структурно недостижима, а не просто запрещена отдельной проверкой.
                        </td>
                    </tr>
