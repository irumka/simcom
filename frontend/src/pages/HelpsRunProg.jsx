            ...
            <table className="table-cyber">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div className="cmd-desc">
                                Вызываем нужный метод ядра. АЛУ считает, пишет в регистры или память. Если инструкция обращается к памяти, адрес по пути проходит через MMU. Флаги ZF и OF пересчитываются по результату.
                            </div>
                        </td>
                    </tr>
